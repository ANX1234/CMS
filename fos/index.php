...
<head>
    ...
    <link rel="icon" href="#">
    <title>Central Meal System</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/10.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Canteen</h4> </div>
                        <!-- end:Step -->
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Popular Delicious Foods<span class="primary-color"></span> </span>
            </div>
        </div>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Fill your hostel name and room number</h3>
